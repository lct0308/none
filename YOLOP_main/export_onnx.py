...
if __name__ == "__main__":
    ...
    model = MCnet(YOLOP)
    checkpoint = torch.load('/data1/pbw/YOLOP-main/runs/MyDataset/_2023-07-28-03-26/epoch-149.pth', map_location=device)
    model.load_state_dict(checkpoint['state_dict'])
    model.eval()

    height = args.height
    width = args.width
    print("Load /data1/pbw/YOLOP-main/runs/MyDataset/_2023-07-28-03-26/epoch-149.pth done!")
    onnx_path = f'./weights/arrow.onnx'
