...
_C.LOSS.CLS_GAIN = 0  # classification loss gain
...
_C.LOSS.LL_SEG_GAIN = 1  # lane line segmentation loss gain
_C.LOSS.LL_IOU_GAIN = 1 # lane line iou loss gain


# DATASET related params
_C.DATASET = CN(new_allowed=True)
_C.DATASET.DATAROOT = '/data1/pbw/Mydataset/images/'       # the path of images folder
_C.DATASET.LABELROOT = '/data1/pbw/Mydataset/label/'      # the path of det_annotations folder
...
_C.TRAIN.ENC_LANE_ONLY = False       # Only train encoder and lane detection branch
_C.TRAIN.ENC_DET_LANE = True       # Only train encoder, detection and lane detection branch
