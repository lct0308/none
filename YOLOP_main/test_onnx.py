...
def infer_yolop(weight="yolop-main.onnx",
...
if __name__ == "__main__":
    ...
    parser.add_argument('--weight', type=str, default="arrow.onnx")
    parser.add_argument('--img', type=str, default="/data1/pbw/Mydataset/images/2023-04-07-21-42-43/1680874967.586637.png")
