...
Train a model:
```
python main.py train --exp_name laneatt_yolop_mydataset_rdi_aug_refine --cfg cfgs/laneatt_mydataset_yolop.yml
```
...
Evaluate a model:
```
python main.py test --exp_name laneatt_r18_once
```
